...
class ContactAdapter constructor(private val context: Context) :
    ...
    private var filtered_icontacts: List<Contact> =
        ArrayList()
    ...
    inner class ContactViewHolder(private val binding: ItemContactBinding) :
        ...
        fun onBind(contact: Contact) {
            ...
            binding.contactName.text = contact.getName()
            binding.contactNumber.text = contact.getPhoneNumber()
            ...
            if (contact.getPhotoUri() != null) {
                ...
                val gradientDrawable =
                    binding.drawableTextView.background as GradientDrawable
                gradientDrawable.setColor(randomColor)
                val serviceSubString = contact.getName()!!.substring(0, 2)
    ...
    private inner class ItemFilter : Filter() {
        override fun performFiltering(constraint: CharSequence): FilterResults {
            ...
            val list = contacts
            val result_list: MutableList<Contact> =
                ArrayList(list!!.size)
            for (i in list.indices) {
                val str_title = list[i].getName()
